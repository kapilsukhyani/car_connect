...
fun BluetoothDevice.connect(): BluetoothSocket {
    ...
    */
    ...
    Log.d(CarConnectApp.TAG, "Starting Bluetooth connection..")
    try {
        sock = this.createRfcommSocketToServiceRecord(MY_UUID)
        sock.connect()
    } catch (e1: Exception) {
        Log.e(CarConnectApp.TAG, "There was an error while establishing Bluetooth connection. Falling back..", e1)
        ...
        try {
            ...
            Log.e(CarConnectApp.TAG, "Couldn't fallback while establishing Bluetooth connection.", e2)
